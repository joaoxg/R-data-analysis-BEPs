combine_csvs_to_excel <- function(presurvey_overview_file = "local path", dataset_file = "housinggame_session_16_240924_surveys\241108_240924_WhereWeMove sessions - presurvey.xlsx", output_suffix = "240924") {
...
# Step 1: Data Settings ------------------------------------------------------------------
  ...
  functionfolder_path <- dirname(script_path)
  # Set path to shared folder with the rawdata two directories up
  datasetfolder_path <- paste0(dirname(dirname(scriptfolder_path)),"/Datasets/")
